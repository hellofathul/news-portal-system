                ...
                <div class="row">
                    <div
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{  route("admin.reset-password.store") }}" class="needs-validation" novalidate="">
                                    @csrf
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input id="email" type="email" class="form-control" name="email" tabindex="1"
                                            value="{{ request()->email }}" required autofocus>
                                        <input id="email" type="hidden" class="form-control" name="token" tabindex="1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password" type="password" class="form-control" name="password"
                                            tabindex="1" required autofocus autocomplete="new-password">
                                        @error('password')
                                            <code>{{  $message  }}</code>
                                        @enderror
