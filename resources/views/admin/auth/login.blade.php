...
<body>
                ...
                <div class="row">
                    <div
                                    ...
                                    <div class="form-group">
                                        <div class="d-block">
                                            ...
                                            <div class="float-right">
                                                <a href="{{ route("admin.forgot-password.send") }}" class="text-small">
                                                    Forgot Password?
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <div class="simple-footer">
                            {{__("Copyright")}} &copy; {{__("Amintix 2024")}}
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{asset('admin/assets/modules/bootstrap/js/bootstrap.min.j')}}s"></script>
